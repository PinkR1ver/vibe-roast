...
export default function Environment() {
  ...
  if (!env) {
    return (
      <div className="space-y-6 animate-fade-in">
        <div>
          <h1 className="text-h1 text-oai-gray-950 dark:text-oai-gray-50">Environment</h1>
          <p className="text-body-sm text-oai-gray-500 mt-1">Codex setup signals</p>
        </div>
        <Card>
          <p className="text-body text-oai-gray-500 text-center py-8">No Codex environment data found.</p>
        </Card>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-h2 text-oai-black dark:text-oai-white">Environment</h1>
        <p className="text-body-sm text-oai-gray-500 mt-1">
          Codex setup at <code className="text-xs bg-oai-gray-100 dark:bg-oai-gray-800 px-1 py-0.5 rounded">{env.home}</code>
        </p>
      </div>
...
function ConfigItem({ label, value }) {
  return (
    <div className="p-3 rounded-lg bg-oai-gray-50 dark:bg-oai-gray-800/50 text-center">
      ...
      <div className="text-body-sm font-medium text-oai-gray-900 dark:text-oai-gray-100">
