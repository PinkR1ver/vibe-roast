...
function ClaudeIcon({ size, className, style }) {
  return (
...
function CodexIcon({ size, className, style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
function CursorIcon({ size, className, style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
function GeminiIcon({ size, className, style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} style={style}>
      <path fill="#4285f4" d="M12 1.1a14.1 14.1 0 0 1-3.7 6.7A14.2 14.2 0 0 1 1.1 12a14.2 14.2 0 0 1 7.2 4.2A14.1 14.1 0 0 1 12 22.9a14.1 14.1 0 0 1 3.7-6.7A14.2 14.2 0 0 1 22.9 12a14.2 14.2 0 0 1-7.2-4.2A14.1 14.1 0 0 1 12 1.1Z" />
      <path fill="#34a853" d="M12 1.1a14.2 14.2 0 0 1-3.7 6.7A14.2 14.2 0 0 1 1.1 12h10.9V1.1Z" opacity=".8" />
      <path fill="#fbbc04" d="M12 22.9a14.2 14.2 0 0 1 3.7-6.7A14.2 14.2 0 0 1 22.9 12H12v10.9Z" opacity=".85" />
      <path fill="#ea4335" d="M12 1.1V12h10.9a14.2 14.2 0 0 1-7.2-4.2A14.2 14.2 0 0 1 12 1.1Z" opacity=".75" />
    </svg>
  );
}

function OpenCodeIcon({ size, className, style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
export function ProviderIcon({ provider, size = 16, className = "", style }) {
