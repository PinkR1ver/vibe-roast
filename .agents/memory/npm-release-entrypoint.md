...
As of the prepared v0.98.2 release, the npm package is `vibe-roast` and runs the dashboard by default:
...
- v0.98.2 is prepared with a product-generic README, clearer privacy language, and an explicit npm download-count explanation.
