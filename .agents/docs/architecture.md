...
- `src/lib/token-tracker-runtime.js` initializes the bundled `tokentracker-cli` collector on first use and syncs it on later launches with telemetry disabled by default for this integration.
