...
- `bin/vibe-roast.js` routes `serve`, `inspect`, `install`, and `uninstall`. No command means `serve`; `bin/vibe-wrapper.js` remains a compatibility alias.
